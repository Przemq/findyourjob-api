...
class CMB2 extends CMB2_Base {
	...
	public function box_types() {
		return CMB2_Utils::ensure_array( $this->prop( 'object_types' ), [ 'post' ] );
	}
	...
	public function is_alternate_context_box() {
		return $this->prop( 'context' ) && in_array( $this->prop( 'context' ), [ 'form_top', 'before_permalink', 'after_title', 'after_editor' ] );
	}
