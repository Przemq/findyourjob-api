...
class CMB2_Field extends CMB2_Base {
	...
	public function update_data( $new_value, $single = true ) {
		$a = $this->data_args( [ 'single' => $single ] );
	...
	public function _set_field_defaults( $args ) {
		...
		$option_types = apply_filters( 'cmb2_all_or_nothing_types', [ 'select', 'radio', 'radio_inline', 'taxonomy_select', 'taxonomy_radio', 'taxonomy_radio_inline' ], $this );
