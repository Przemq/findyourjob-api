...
class CMB2_Sanitize {
	...
	public function default_sanitization() {
		...
		if ( function_exists( 'apply_filters_deprecated' ) ) {
			$override_value = apply_filters_deprecated( "cmb2_validate_{$this->field->type()}", [ null, $this->value, $this->field->object_id, $this->field->args(), $this ], '2.0.0', "cmb2_sanitize_{$this->field->type()}" );
		} else {
